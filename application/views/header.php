    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation no-print">
            ...
            <div class="navbar-header">
                ...
                <img  class="navbar-brand" src="asset/batan.png"> <a href="index.php " class="navbar-brand"> Aplikasi Barang Gudang</a>
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="home/logout"><i class="fa fa-fw fa-power-off"></i> Keluar</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div style="background-color: black;" class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="<?=is_same(2,$menu,"active")?>">
                        <a href="javascript:;" data-toggle="collapse" data-target="#master"><i class="fa fa-fw fa-bars"></i> Data Barang Gudang <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="master"  class="<?=is_not_same(2,$menu,"collapse")?>">
                            <li class="<?=is_same(21,$submenu,"active")?>">
                                <a href="master/cc"> - Barang</a>
                            </li>
