...
Class Mutasi extends CI_Controller{
	...
	public function add($idmaster){
		...
		$row = $this->cms->get_page("cc_master",$idmaster);
		$data['title'] = "Tambah Data Terima barang ".$row['nama'];
		$data['tgl'] = date("Y-m-d");
	...
	public function kirim($idmaster,$iddiv=0){
		...
		$row = $this->cms->get_page("cc_master",$idmaster);
		$data['title'] = "Tambah Data Kirim Barang ".$row['nama'];
		$data['tgl'] = date("Y-m-d");
	...
	public function pengiriman(){
		$curr = shortcode_login();
		$data['title'] = "Rekap Stok Barang per Divisi";
		$data['menu'] = 4;
		$data['curr'] = $curr;
	...
	public function detaildivisi($iddivisi){
		...
		$data['title'] = "Detail Rekap Stok Barang di ".$list[$iddivisi];
		$data['curr'] = $curr;
